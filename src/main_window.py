...
class BlocksWindow(ProjectManagerMixin, EventHandlerMixin, VhdlViewerMixin, ComponentLibraryMixin, Gtk.Window):
    def __init__(self):
        ...
        arithmetic_buttons = [
            ...
            ("4-bit Kogge-Stone Adder", "KS4"),
            ("4-bit Brent-Kung Adder", "BK4"),
            ("Carry Save Adder (1-bit)", "CSA"),
            ("3-operand Wallace Tree Adder", "WALLACE3_4"),
            ("4-bit Modular Adder", "MOD_ADD4"),
            ("4x4 Array Multiplier", "ARRAY_MULT4"),
            ("4-bit Booth Multiplier", "BOOTH_MULT4"),
            ("4-bit Squarer", "SQ4"),
            ("4-bit Restoring Divider", "REST_DIV4"),
            ("4-bit Non-Restoring Divider", "NONREST_DIV4"),
            ("4-bit SRT Divider", "SRT_DIV4"),
            ("GF(2^4) Adder", "GF_ADD4"),
            ("GF(2^4) Multiplier", "GF_MUL4"),
            ("4-bit Radix-4 Booth Multiplier", "BOOTH4_MULT4"),
            ("3-operand Dadda Tree Adder", "DADDA4"),
            ("4-bit Barrel Shifter", "BSR4"),
            ("4-bit Modular Multiplier", "MOD_MUL4"),
        ]
