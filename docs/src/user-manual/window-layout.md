...
The **Components** expander includes a **search box** — type any substring to filter the component list in real time. Clear the search box to show all saved components.
